...
const SignUp = () => {
    ...
    const { values, error, handleSubmit, handleChange } = useValidation(INIT_STATE, validateSignUp, signUp)
        ...
        <div className='login-pop'>
            ...
            >
                ...
                <Campo>
                    ...
                    <input id='email' onChange={handleChange} name='email' value={values.email} type='email' />
                </Campo>
                {error.email ? <Error>{error.email}</Error> : null}
                <Campo>
                    <label htmlFor='password'>Contraseña</label>
                    <input id='password' onChange={handleChange} name='password' value={values.password} type='password' />
                </Campo>
                {error.password ? <Error>{error.password}</Error> : null}
                <Campo>
                    <label htmlFor='rePassword'>Repita contraseña</label>
                    <input id='rePassword' onChange={handleChange} name='rePassword' value={values.rePassword} type='password' />
                </Campo>
                {error.rePassword ? <Error>{error.rePassword}</Error> : null}
