...
const ValidateEmail = () => {
    ...
    const { values, error, handleSubmit, handleChange } = useValidation(INIT_STATE, validateCodeEmail, validateEmail)
        ...
        <div className='login-pop'>
            ...
            >
                ...
                <Campo>
                    ...
                    <input id='codeValidation' onChange={handleChange} name='codeValidation' value={values.codeValidation} type='text' />
                </Campo>
                {error.codeValidation ? <Error>{error.codeValidation}</Error> : null}
               
    
                <InputSubmit type='submit' value='Validar' />
            </Formulario>
