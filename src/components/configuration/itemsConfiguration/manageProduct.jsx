...
import {
    saveProductAction, showMadalNewProductAction, showModalCategoryAction, productToCreateAction
                ...
                <ContainerButtons>
                    <ContainerButton>
                        <Buttons role="button">
                            ...
                            <div>
                                <AddButon onClick={(e) => { handlerSHowModalNewProduct(e) }}>Añadir nuevo producto</AddButon>
                            </div>
                            <div>
                                <ArrowImg src={arrow} alt="arrow" />
                            </div>
