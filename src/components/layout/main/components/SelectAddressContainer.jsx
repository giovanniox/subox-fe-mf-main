...
import { getRegionAction, clearCity, getCityAction, traceCommuneAction, regionSelectAction, clearCommune, getCommuneAction, citySelectAction, communeSelectAction } from '../../../../redux/actions/shippingTypeActions';
