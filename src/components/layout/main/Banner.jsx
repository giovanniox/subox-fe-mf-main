...
const Banner = () => {
    return (
        <BannerContainer>
            ...
            <ImgBannerContainer>
                <a href="https://www.instagram.com/" rel="noreferrer" target="_blank"><ImgBanner src={instagram} alt="instagram" /></a>
                <a href="https://www.facebook.com/" rel="noreferrer" target="_blank"><ImgBanner src={facebook} alt="facebook" /></a>
            </ImgBannerContainer>
        </BannerContainer>
